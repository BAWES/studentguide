...
// show stick flash message in side bar 
function side_bar_flash_message(cls,add_cls,rmv_cls,msg){
	$('.'+cls).removeClass(rmv_cls).addClass(add_cls).html('<p>'+msg+'</p>').fadeIn().delay(5000).fadeOut();	
}
