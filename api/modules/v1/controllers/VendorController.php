...
class VendorController extends BaseController
{
    ...
    */
    ...
    public function actionVendorgallery($language = "en")
    {
        ...
        {
            $rows               = (new \yii\db\Query())->select(['photo' => 'photo_url', 'vendor_id', 'gallery_id', 'sort_order' => new \yii\db\Expression('IFNULL(sort_order, 0)')])->from('{{%vendor_gallery}}')->all();
        }
